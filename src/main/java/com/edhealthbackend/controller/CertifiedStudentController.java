...
@QueryMapping
public CertifiedStudentPage certifyStudent(@Argument(name = "trainingApplicationId")long trainingApplicationId,@Argument(name = "input")CertifiedStudentInput input){
